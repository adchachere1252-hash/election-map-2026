// Map from ISO 3166-1 numeric codes (used in world-atlas TopoJSON) to ISO alpha-2 codes
// This allows us to match TopoJSON geometries to our database records
export const numericToAlpha2: Record<string, string> = {
  ...
  "728": "SS", "729": "SD", "732": "EH", "740": "SR", "744": "SJ",
...
// Reverse map: alpha-2 to numeric
export const alpha2ToNumeric: Record<string, string> = Object.fromEntries(
  Object.entries(numericToAlpha2).map(([k, v]) => [v, k])
);
